...
void Widget::Check_Blocking_Up(){
    ...
    //    if(test) qDebug()<<"\nFinal finish part adjust!";
    //    if(!Check_in_column(0,4)){
    //        if(wall[0][2]==1){
    //            wall[0][2] = 0;
    //            wall[1][1] = 0;
    //            if(visible == 1) myDrawLine(0,1);
    //        }
    //        wall[0][3] = 1;
    //        wall[8][0] = 1;
    //        if(visible == 1) myDrawLine(0,8,Qt::gray);
    //        if(wall[8][2]==1){
    //            wall[8][2]=0;
    //            wall[9][1]=0;
    //            if(visible == 1) myDrawLine(8,9);
    //        }
    //    }
    //    if(!Check_in_column(7,4)){
    //        if(wall[7][1]==1){
    //            wall[7][1]=0;
    //            wall[6][2]=0;
    //            if(visible == 1) myDrawLine(6,7);
    //        }
    //        wall[7][3]=1;
    //        wall[15][0]=1;
    //        if(visible == 1) myDrawLine(7,15,Qt::gray);
    //        if(wall[15][1]==1){
    //            wall[14][2]=0;
    //            wall[15][1]=0;
    //            if(visible == 1) myDrawLine(14,15);
    //        }
    //        if(wall[14][0]==1){
    //            wall[14][0] = 0;
    //            wall[6][3] = 0;
    //            if(visible == 1) myDrawLine(14,6);
    //        }
    //    }
}
...
void Widget::keyPressEvent(QKeyEvent *event)
{
    ...
    //结束界面
    if(red_index==0){
        if(green_index==ROWNUM-1)
            showResultWindow(2);
        else showResultWindow(0);
    }else if(green_index==ROWNUM-1){
        showResultWindow(1);
    }
}
